...
def _handle_dimension_ordering():
    ...
    global COL_AXIS
    global CHANNEL_AXIS
    print ("K.image_dim_ordering()====",K.common.image_dim_ordering())
...
def Drcon_architecture(inputs,residual_block_num,filters,kernel_size):
...
WEIGHT_PATH = project_root+"/"+str("best_val_weights_64.hdf5")
...
model =  Drcon_architecture(inputs=_inputs,filters=32,residual_block_num=60,kernel_size=3)
model.summary()
...
filename=output_dir+target_id+"_predicted.rr"
