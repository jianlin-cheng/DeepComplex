...
use constant{
	...
	JACKHMMERDB => '/storage/htc/bdm/farhan/string_db/databases/combined_fasta_AB_BA_filtered_1.0',#'/storage/htc/bdm/farhan/string_db/combined_strings_db/filter_combo/all_sequences.txt',
	...
	HHBLITSDB   => '/storage/htc/bdm/tools/multicom_db_tools/databases/uniprot20/uniprot20_2016_02/uniprot20_2016_02',
	CPU         => 2
};
