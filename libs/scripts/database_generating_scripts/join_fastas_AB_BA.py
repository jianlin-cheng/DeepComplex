...
with open ("combined_fasta_AB.txt","w") as f:
    f.writelines(AB_list)

with open ("combined_fasta_BA.txt","w") as f:
    f.writelines(BA_list)

with open ("heterodimers_pairs_new.txt","w") as f:
    f.writelines(new_heter_pairs_list)
