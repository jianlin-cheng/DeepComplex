...
#this script reads the folder of fastafiles and creates a fasta dictionary
...
seq_folder=os.path.abspath(sys.argv[1])+"/" #"/data/farhan/SoftwareTools/HomopolymerProject/data/homooligomers/original_pdbs_7400/work_dir/seq/"
...
with open (seq_list,"r") as f:
    for pdb in f:
        ...
        name=""
        #print(seqfile)
        #print(seq_folder+seqfile.strip())
        #sys.exit()
...
with open (fasta_dict_file,"w") as f:
