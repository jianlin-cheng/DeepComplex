...
#usage: python getPrecision_inter.py <rr_file_inter_true> <rr_file_predicted> 
from readRR import *
import numpy as np
import os,sys
...
usage_inter="python getPrecision_inter.py <rr_file_inter_true> <rr_file_predicted>" # 6BZE_AE.rr 6BZE_A.dncon2.rr 6BZE_AA.rr 
