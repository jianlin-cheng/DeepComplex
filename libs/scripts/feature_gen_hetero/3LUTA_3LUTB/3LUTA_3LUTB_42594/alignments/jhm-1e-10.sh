...
/storage/htc/bdm/tools/hmmer-3.1b2-linux-intel-x86_64/binaries/jackhmmer --cpu 19 -N 5 -E 1e-10 -A jhm-1e-10.ali 3LUTA_3LUTB.jh.fasta /storage/htc/bdm/farhan/string_db/combined_strings_db/filter_combo/all_sequences.txt > jhm-1e-10-jackhmmer.log
if [ ! -f "jhm-1e-10.ali" ]; then
   mv jhm-1e-10.running jhm-1e-10.failed
   echo "jackhmmer job jhm-1e-10 failed!"
   exit
fi
/storage/htc/bdm/farhan/DeepComplex/feature_gen_hetero_dncon2/reformat.pl -l 1500 -d 1500 sto a3m jhm-1e-10.ali jhm-1e-10.a3m
