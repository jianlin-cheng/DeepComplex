...
####################################################################################################
use constant{
	FREECONTACT=> '/storage/htc/bdm/tools/freecontact-1.0.21/bin/freecontact',
	#PSICOV    => '/storage/htc/bdm/tools/PSICOV2.1/psicov',
	#CCMPRED   => '/storage/htc/bdm/Collaboration/jh7x3/Contact_prediction_with_Tianqi/CAMEO_test/psicov/psicov_lotus/CCMpred-0.1.0/bin/ccmpred',
	PSICOV    => '/storage/htc/bdm/tools/psicov/psicov21',
...
if (-s "$psicovdir/d0.03/$id-d0.03.psicov"){
	...
	print "Looks like none of the PSICOV jobs finished!\n"; # modified by Jie 10/09/2017
