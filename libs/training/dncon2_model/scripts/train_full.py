...
def calculateEvaluationStats(pred_cmap, true_cmap, name):
    ...
    os.system("python "+project_root+"lib/conevainter_usingY_Labels.py "+project_root+"true_cmap.rr "+project_root+"pred_cmap.rr > "+project_root+"temp_prec.txt")
...
LTR1 = subset_pdb_dict(train_l,   0, 1000, 1000, 'random')
LTR2 = subset_pdb_dict(train_l, 1000, 2000, 1000, 'random')
LTR3 = subset_pdb_dict(train_l, 2000, 3050, 1000, 'random')
LTR.append(LTR1)
LTR.append(LTR2)
LTR.append(LTR3)
...
LTV1 = subset_pdb_dict(val_l,   0, 1000, 1000, 'ordered')
LTV2 = subset_pdb_dict(val_l, 1000, 2000, 1000, 'ordered')
LTV3 = subset_pdb_dict(val_l, 2000, 3050, 1000, 'ordered')
LTR.append(LTV1)
LTR.append(LTV2)
LTR.append(LTV3)
print ('Loading sets X1, X2, and X3..')
...
LTE1 = subset_pdb_dict(test_l,   0, 1000, 1000, 'ordered')
LTE2 = subset_pdb_dict(test_l, 1000, 2000, 1000, 'ordered')
LTE3 = subset_pdb_dict(test_l, 2000, 3050, 1000, 'ordered')
LTR.append(LTE1)
LTR.append(LTE2)
LTR.append(LTE3)
...
print ("Lengths of LTR, XTR, YTR = ",len(LTR), len(XTR), len(YTR))
...
for cyc in range (0, train_param['outer_epochs']):
    ...
    with open ("training_acc.txt","a+") as f:
        epoch = cyc
        if (epoch == 0):
            f.write("Epoch\tSample_Size\tPrec-T5\tPrec-T10\tL/30\tL/20\tL/10\tL/10\tL/5\n")
