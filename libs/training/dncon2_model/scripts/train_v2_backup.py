...
def calculateEvaluationStats(pred_cmap, true_cmap, name):
    ...
    subprocess.call("cp "+project_root+name+"_pred_cmap.rr "+cmap_folder+name+"_pred.rr",shell=True)
    #print ("EC: ",exit_code)
    time.sleep(2)
    ...
    subprocess.call("python "+project_root+"/lib/sortrr.py "+cmap_folder+name+"_pred.rr True > "+cmap_folder+name+"_sorted_pred.rr")
    #print ("EC: ",exit_code)
    ...
    subprocess.call("python "+project_root+"lib/conevainter_usingY_Labels.py "+project_root+name+"_true_cmap.rr "+project_root+name+"_pred_cmap.rr "+fasta_folder+name+".fasta")
    time.sleep(2)
    ...
    subprocess.call("python "+project_root+"lib/conevainter_usingY_Labels.py "+project_root+name+"_true_cmap.rr "+project_root+name+"_pred_cmap.rr "+fasta_folder+name+".fasta > "+project_root+name+"_temp_prec.txt")
    time.sleep(2)
    #print ("EC: ",exit_code)
    #time.sleep(20)
...
LTR1 = subset_pdb_dict(train_l,   0, 175, 10, 'random')
LTR2 = subset_pdb_dict(train_l, 175, 250, 10, 'random')
LTR3 = subset_pdb_dict(train_l, 250, 300, 10, 'random')
LTR.append(LTR1)
LTR.append(LTR2)
LTR.append(LTR3)
...
LTV1 = subset_pdb_dict(val_l,   0, 175, 10, 'ordered')
LTV2 = subset_pdb_dict(val_l, 175, 250, 10, 'ordered')
LTV3 = subset_pdb_dict(val_l, 250, 300, 10, 'ordered')
LTR.append(LTV1)
LTR.append(LTV2)
LTR.append(LTV3)
print ('Loading sets X1, X2, and X3..')
...
LTE1 = subset_pdb_dict(test_l,   0, 175, 10, 'ordered')
LTE2 = subset_pdb_dict(test_l, 175, 250, 10, 'ordered')
LTE3 = subset_pdb_dict(test_l, 250, 300, 10, 'ordered')
LTR.append(LTE1)
LTR.append(LTE2)
LTR.append(LTE3)
