...
######
pdb=data3[1:sqrt(L3_A*L3_B)/10,]
plot(pdb$V1, pdb$V2, col="red", xlab = paste0("Seq_B: ",B), ylab = paste0("Seq_A: ",A), ylim=c(L3_B, 0), xlim=c(0, L3_A), pch = 1)
title("Hoeterodimer Top-L/10 Contacts")
dev.off()
