...
def getName(name):
    ...
    return name
########################################################################################################
usage_inter="python getPrecision_inter.py <rr_file_inter_true> <rr_file_predicted>" 
...
if (len(sys.argv)!=3): 
    ...
    rr_file2=os.path.abspath(sys.argv[2]) #the prediction file
    #rr_file_intra=os.path.abspath(sys.argv[3]) #the true intra chain contacts
