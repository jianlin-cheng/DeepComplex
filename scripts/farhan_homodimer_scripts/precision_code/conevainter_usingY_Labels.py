...
#    if (top=="L/2" or top=="l/2"): val=int(round((L/2),0))
    ...
    if (top=="L/20" or top=="l/2"): val=int((L/20)+0.5)
    if (top=="L/30" or top=="l/2"): val=int((L/30)+0.5)
...
if (len(sys.argv)!=3): 
    print(len(sys.argv))
    sys.exit("Please enter 2 valid arguments\n"+usage_inter)
else:
    ...
    os.system("python Label2cmap.py "+rr_file1+" "+dirnm+"temp_rr.rr")
    rr_file1=dirnm+"temp_rr.rr"
...
############################################################
    ...
    for relax_prec in range(relaxation):
        ...
        string3=name+"        "+top["Top-5"]+"         "+top["Top-10"]+"         "+top["Top-L/30"]+"          "+top["Top-L/20"]+"          "+top["Top-L/30"]+"          "+top["Top-L/5"]
