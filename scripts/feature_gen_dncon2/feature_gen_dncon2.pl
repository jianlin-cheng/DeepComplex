...
# Modified by Farhan, 05-10-2020, for interchain homodimers
use strict;
use warnings;
use Carp;
use Cwd 'abs_path';
...
use constant{
	...
	BLASTNRDB    => '/storage/htc/bdm/tools/databases/nr90-2012', #update to a new one available- 2016 or 2020 (needs to be created)
...
print "All features are generated and kept in the feat-$id.txt file";
