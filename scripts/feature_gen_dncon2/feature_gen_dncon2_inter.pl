...
# Modified by Farhan, 06-18-2020, for interchain heteromers. Main update is turning off hhsuite and using jackhmmr. Also concatenation of alignment independent features.
use strict;
use warnings;
use Carp;
use Cwd 'abs_path';
...
use constant{
	...
	BLASTNRDB    => '/storage/htc/bdm/tools/databases/nr90-2012', #update to latest if available- 2016 or 2020 (needs to be created)
