...
# Modified by Farhan, 05-10-2020, for interchain homodimers, Main update is the database change to latest (03/2020) uniref30, and jackhmmr db
use strict;
use warnings;
use Carp;
use Cwd 'abs_path';
...
use constant{
	...
	#JACKHMMERDB => '/storage/htc/bdm/tools/uniref_updated/uniref90_04_2018/uniref90',
	JACKHMMERDB => '/storage/htc/bdm/zhiye/DNCON4_db_tools/databases/myg_uniref100_01_2020/myg_uniref100', #'/storage/htc/bdm/tools/multicom_db_tools/databases/uniref/uniref90.fasta',
	#HHBLITS     => '/storage/htc/bdm/tools/DNCON2/install/hhsuite-2.0.16-linux-x86_64/bin/hhblits',
    HHBLITS => '/storage/htc/bdm/tools/hhsuite-3.0-beta.1/bin/hhblits',#'/storage/htc/bdm/tools/HHsuite/hhsuite-2.0.16/bin/hhblits',
	HHBLITSDB   => '/storage/htc/bdm/tools/databases/UniRef30_2020_03/UniRef30_2020_03',#'/storage/htc/bdm/tools/multicom_db_tools/databases/uniprot20/uniprot20_2016_02/uniprot20_2016_02',
	CPU         => 2
};
...
confess 'Oops!! hhblitsdb not found!'   if not -f HHBLITSDB.'_a3m.ffdata';
