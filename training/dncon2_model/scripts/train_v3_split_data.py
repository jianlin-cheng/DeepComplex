...
# upper limit length
# lower limit length
# if no sample found for test and val, use training data for it
...
LTR1 = subset_pdb_dict(train_l,   0, 100, 500, 'random')
LTR2 = subset_pdb_dict(train_l, 100, 2000, 1000, 'random')
LTR3 = subset_pdb_dict(train_l, 2000, 3050, 10, 'random')
LTR.append(LTR1)
LTR.append(LTR2)
LTR.append(LTR3)
...
LTV1 = subset_pdb_dict(val_l,   0, 1000, 100, 'ordered')
LTV2 = subset_pdb_dict(val_l, 1000, 2000, 100, 'ordered')
LTV3 = subset_pdb_dict(val_l, 2000, 3050, 10, 'ordered')
LTR.append(LTV1)
LTR.append(LTV2)
LTR.append(LTV3)
print ('Loading sets X1, X2, and X3..')
