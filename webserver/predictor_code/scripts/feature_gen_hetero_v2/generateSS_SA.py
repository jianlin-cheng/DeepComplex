...
cmd1="more '"+fasta +"' >> "+outfolder+name+".ss_sa"
fasta_file_list=[]
with open (fasta,"r") as f:
    for line in f:
        fasta_file_list.append(line.strip()+"\n")
with open (outfolder+name+".ss_sa","a") as f:
    f.writelines(fasta_file_list)
...
os.system (command2+" && "+cmd4+" && "+cmd5+" && "+cmd6+" && "+"cat "+outfolder+name+".ss_sa")
